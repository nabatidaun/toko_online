<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('kategori/poster'); ?>">
                    <i class="fas fa-fw fa-file"></i>
                    <span>Poster</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('kategori/pamflet'); ?>">
                    <i class="fas fa-fw fa-file"></i>
                    <span>Pamflet</span></a>
            </li>
                        ...
                        <div class="navbar">
                            <ul class="nav navbar-nav navbar-right">
                                <li>
                                    ...
                                    //tampilkan teks
                                    $keranjang = 'Keranjang Belanja: ' . $totalItems . ' items';
                                    ?>

                                    <!--tampilkan teks keranjang-->
